<!-- src/modules/ssl/apply/JobManager.vue -->
<template>
  <n-card title="证书申请" class="mb-6">
    <!-- 任务筛选 -->
    ...
    <!-- 任务列表 -->
    <n-empty v-if="jobs.length === 0" description="暂无申请任务" />
...
import JobFormModal from '@/modules/ssl/apply/JobFormModal.vue'
import JobLogModal from '@/modules/ssl/apply/JobLogModal.vue'
